...
function CAdvertStackScreen(){
  return(
    <CAdvertsStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <CAdvertsStack.Screen name="CAdvertDetailsScreen" component={CAdvertDetailsScreen} />
      <CAdvertsStack.Screen name="CApplicationsScreen" component={CApplicationsScreen} />
      <CAdvertsStack.Screen name="CreateAdvertScreen" component={CreateAdvertScreen} />
      <CAdvertsStack.Screen name="ApplicantProfileScreen" component={ApplicantProfileScreen} />
...
function CTabScreen(){
  return(
    ...
    >
      <CTab.Screen name='Home' component={HomeScreen} options={{ tabBarLabel: 'Anasayfa' }} />
      <CTab.Screen name='CProfile' component={CProfileScreen} options={{ tabBarLabel: 'Profil' }} />
      <CTab.Screen name='CAdverts' component={CAdvertStackScreen} options={{ tabBarLabel: 'İlanlarım' }} />
    </CTab.Navigator>
  );
}
